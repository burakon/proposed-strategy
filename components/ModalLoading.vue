...
const flavorTextValueArr = ["どきどきどきどき…▼", "相手は眉をひそめている…▼", "相手は悩んでいるようだ…▼"];
        ...
        <Modal :show="show">
            <div class="bg-gray-800 progress">
                <div class="flex gap-1 mb-1 item-align-center justify-center">
                    <img src="/images/Brave_2.gif" class="block" width="80" height="80" alt="自分" />
                    <img src="/images/Erlking_2.gif" class="block" width="80" height="80" alt="恋人" />
                </div>
